...
ВЫБРАТЬ
	...
	СправочникНоменклатуры.НоменклатурнаяГруппа КАК nom_group,
	ВЫРАЗИТЬ(ЗначенияАктуальность.Значение КАК Справочник.ЗначенияСвойствОбъектов) КАК product_group_2,
	ВЫРАЗИТЬ(ЗначенияГруппаТкани.Значение КАК Справочник.ЗначенияСвойствОбъектов) КАК textile_group,
	ВЫРАЗИТЬ(ЗначенияНомерТкани.Значение КАК Справочник.ЗначенияСвойствОбъектов) КАК textile_n,
	ВЫРАЗИТЬ(ЗначенияПринт.Значение КАК Справочник.ЗначенияСвойствОбъектов) КАК print_color,
	ВЫРАЗИТЬ(ЗначенияРАЗМЕР.Значение КАК Справочник.ЗначенияСвойствОбъектов) КАК size,
	ВЫРАЗИТЬ(ЗначенияСтатусИзделия.Значение КАК Справочник.ЗначенияСвойствОбъектов) КАК product_status,
	ВЫРАЗИТЬ(ЗначенияТГ.Значение КАК Справочник.ЗначенияСвойствОбъектов) КАК product_group,
	ВЫРАЗИТЬ(ЗначенияТипТкани.Значение КАК Справочник.ЗначенияСвойствОбъектов) КАК fabric_type,
	ВЫРАЗИТЬ(ЗначенияТипТовара.Значение КАК Справочник.ЗначенияСвойствОбъектов) КАК item,
	ВЫРАЗИТЬ(ЗначенияТкань.Значение КАК Справочник.ЗначенияСвойствОбъектов) КАК textile,
	ВЫРАЗИТЬ(ЗначенияФорма.Значение КАК Справочник.ЗначенияСвойствОбъектов) КАК form,
